...
const Sidebar = () => {
  ...
  return (
    <aside className=' w-[280px] h-[112vh] rounded-md overflow-auto lg:flex items-center flex-col gap-4  border-pink-400 border-x-[#ff6198]  p-2 hidden bg-yellow-100 shadow-xl py-4 '>
  <Link href='/' className='w-full  flex items-center justify-center'>
    <Image src="/assets/images/logo-1.png" alt='logo' className='object-contain ' width={125} height={10} />
  </Link>
  <SignedIn>
 <ul className='flex flex-col  gap-4 w-full h-[100%]  ' >
